...
#
# r5ctrlr.tcl: Tcl script for re-creating project 'r5ctrlr'
#
# Generated by Vivado on Tue Mar 17 08:06:15 CET 2026
...
#
# 1. This project restoration tcl script (r5ctrlr.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/xilinxworks/ZCU102/v2025.2/r5ctrlr/r5ctrlr/hardware/r5ctrlr/r5ctrlr.srcs/constrs_1/imports/r5ctrlr/zcu102_Rev1.0_U1_09152016.xdc"
#    "/xilinxworks/ZCU102/v2025.2/r5ctrlr/r5ctrlr/hardware/r5ctrlr/r5ctrlr.srcs/constrs_1/new/r5ctrlr-extra-constr.xdc"
#    "/xilinxworks/ZCU102/v2025.2/r5ctrlr/r5ctrlr/hardware/r5ctrlr/r5ctrlr.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/r5ctrlr.srcs/constrs_1/imports/r5ctrlr/zcu102_Rev1.0_U1_09152016.xdc"]"\
 "[file normalize "$origin_dir/r5ctrlr.srcs/constrs_1/new/r5ctrlr-extra-constr.xdc"]"\
 "[file normalize "$origin_dir/r5ctrlr.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set file "[file normalize ${origin_dir}/r5ctrlr.srcs/constrs_1/imports/r5ctrlr/zcu102_Rev1.0_U1_09152016.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "r5ctrlr/zcu102_Rev1.0_U1_09152016.xdc"
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/r5ctrlr.srcs/constrs_1/new/r5ctrlr-extra-constr.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/r5ctrlr-extra-constr.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set_property -name "target_constrs_file" -value "[get_files [list "*new/r5ctrlr-extra-constr.xdc"]]" -objects $obj
set_property -name "target_ucf" -value "[get_files [list "*new/r5ctrlr-extra-constr.xdc"]]" -objects $obj
...
proc cr_bd_design_1 { parentCell } {
  ...
  user.org:user:regbank:1.0\
  xilinx.com:ip:xlconstant:1.1\
  xilinx.com:ip:util_vector_logic:2.0\
  xilinx.com:ip:axi_quad_spi:3.2\
  www.maxiv.lu.se:user:AD3552_SPI:1.0\
  user.org:user:QUAD_ADAQ23876:1.0\
  ...
  # Create ports
  set FMC_HPC0_LA13_N [ create_bd_port -dir O FMC_HPC0_LA13_N ]
  set FMC_HPC0_LA13_P [ create_bd_port -dir I FMC_HPC0_LA13_P ]
  set FMC_HPC0_LA15_P [ create_bd_port -dir O FMC_HPC0_LA15_P ]
  set FMC_HPC0_LA10_P [ create_bd_port -dir O FMC_HPC0_LA10_P ]
  set FMC_HPC0_LA10_N [ create_bd_port -dir O FMC_HPC0_LA10_N ]
  set FMC_HPC0_LA32_P [ create_bd_port -dir O FMC_HPC0_LA32_P ]
  set FMC_HPC0_LA32_N [ create_bd_port -dir O -type rst FMC_HPC0_LA32_N ]
  set DAC_1_2_SPI_SDIO [ create_bd_port -dir IO -from 3 -to 0 DAC_1_2_SPI_SDIO ]
  set FMC_HPC0_LA27_P [ create_bd_port -dir O FMC_HPC0_LA27_P ]
  set FMC_HPC0_LA27_N [ create_bd_port -dir O FMC_HPC0_LA27_N ]
  set FMC_HPC0_LA30_N [ create_bd_port -dir O FMC_HPC0_LA30_N ]
  set DAC_3_4_SPI_SDIO [ create_bd_port -dir IO -from 3 -to 0 DAC_3_4_SPI_SDIO ]
  set adc_cnv_p [ create_bd_port -dir O -from 3 -to 0 adc_cnv_p ]
  set adc_cnv_n [ create_bd_port -dir O -from 3 -to 0 adc_cnv_n ]
  set adc_SCLK_p [ create_bd_port -dir O -from 3 -to 0 adc_SCLK_p ]
  set adc_SCLK_n [ create_bd_port -dir O -from 3 -to 0 adc_SCLK_n ]
  set adc_DA_p [ create_bd_port -dir I -from 3 -to 0 adc_DA_p ]
  set adc_DA_n [ create_bd_port -dir I -from 3 -to 0 adc_DA_n ]
  set adc_DB_p [ create_bd_port -dir I -from 3 -to 0 adc_DB_p ]
  set adc_DB_n [ create_bd_port -dir I -from 3 -to 0 adc_DB_n ]
  set PMOD1_3 [ create_bd_port -dir O PMOD1_3 ]
  set PMOD1_5 [ create_bd_port -dir O PMOD1_5 ]
  set PMOD1_4 [ create_bd_port -dir I PMOD1_4 ]
  set PMOD1_1 [ create_bd_port -dir I PMOD1_1 ]
  set PMOD1_0 [ create_bd_port -dir I PMOD1_0 ]
  set PMOD1_7 [ create_bd_port -dir O -from 0 -to 0 PMOD1_7 ]
  set PMOD0_0 [ create_bd_port -dir O -from 0 -to 0 PMOD0_0 ]
  set PMOD0_1 [ create_bd_port -dir O -from 0 -to 0 PMOD0_1 ]
  set PMOD0_2 [ create_bd_port -dir O -from 0 -to 0 PMOD0_2 ]
  set PMOD0_3 [ create_bd_port -dir O -from 0 -to 0 PMOD0_3 ]
  set PMOD0_7 [ create_bd_port -dir O -from 0 -to 0 PMOD0_7 ]
  set PMOD1_2 [ create_bd_port -dir O -from 0 -to 0 PMOD1_2 ]
  set PMOD1_6 [ create_bd_port -dir O -from 0 -to 0 PMOD1_6 ]
  set FMC_HPC0_LA16_N [ create_bd_port -dir O -from 0 -to 0 FMC_HPC0_LA16_N ]
  set FMC_HPC0_LA33_N [ create_bd_port -dir O -from 0 -to 0 FMC_HPC0_LA33_N ]
  set FMC_HPC0_LA15_N [ create_bd_port -dir O -from 0 -to 0 FMC_HPC0_LA15_N ]
  set PMOD0_4 [ create_bd_port -dir O -from 0 -to 0 PMOD0_4 ]
...
\
  ...
  # Create instance: reset_125MHz, and set properties
  set reset_125MHz [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 reset_125MHz ]
  ...
  # Create instance: regbank_0, and set properties
  set regbank_0 [ create_bd_cell -type ip -vlnv user.org:user:regbank:1.0 regbank_0 ]
  ...
  # Create instance: max7301_spi_0, and set properties
  set max7301_spi_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_quad_spi:3.2 max7301_spi_0 ]
  set_property -dict [list \
  ...
  # Create instance: AD3552_SPI_A, and set properties
  set AD3552_SPI_A [ create_bd_cell -type ip -vlnv www.maxiv.lu.se:user:AD3552_SPI:1.0 AD3552_SPI_A ]

  # Create instance: AD3552_SPI_B, and set properties
  set AD3552_SPI_B [ create_bd_cell -type ip -vlnv www.maxiv.lu.se:user:AD3552_SPI:1.0 AD3552_SPI_B ]

  # Create instance: r5_sleep_timer_0, and set properties
  set r5_sleep_timer_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_timer:2.0 r5_sleep_timer_0 ]

  # Create instance: QUAD_ADAQ23876_0, and set properties
  set QUAD_ADAQ23876_0 [ create_bd_cell -type ip -vlnv user.org:user:QUAD_ADAQ23876:1.0 QUAD_ADAQ23876_0 ]

  # Create instance: LDAC_inv, and set properties
  set LDAC_inv [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic:2.0 LDAC_inv ]
  set_property -dict [list \
    CONFIG.C_OPERATION {not} \
    CONFIG.C_SIZE {1} \
  ] $LDAC_inv
  ...
  # Create instance: pulldown_2, and set properties
  set pulldown_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 pulldown_2 ]
  set_property -dict [list \
    CONFIG.CONST_VAL {15} \
  ...
  # Create instance: SofiaIO_gpio, and set properties
  set SofiaIO_gpio [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 SofiaIO_gpio ]
  set_property -dict [list \
  ...
  # Create instance: SofiaIO_spi, and set properties
  set SofiaIO_spi [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_quad_spi:3.2 SofiaIO_spi ]
  set_property -dict [list \
...
connect_bd_intf_net -intf_net QUAD_ADAQ23876_0_M_AXIS [get_bd_intf_pins QUAD_ADAQ23876_0/M_AXIS] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins regbank_0/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins ps8_0_axi_periph/M03_AXI] [get_bd_intf_pins max7301_spi_0/AXI_LITE]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M04_AXI [get_bd_intf_pins ps8_0_axi_periph/M04_AXI] [get_bd_intf_pins AD3552_SPI_A/S00_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M05_AXI [get_bd_intf_pins ps8_0_axi_periph/M05_AXI] [get_bd_intf_pins AD3552_SPI_B/S00_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M06_AXI [get_bd_intf_pins ps8_0_axi_periph/M06_AXI] [get_bd_intf_pins r5_sleep_timer_0/S_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M07_AXI [get_bd_intf_pins ps8_0_axi_periph/M07_AXI] [get_bd_intf_pins QUAD_ADAQ23876_0/S00_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M08_AXI [get_bd_intf_pins ps8_0_axi_periph/M08_AXI] [get_bd_intf_pins SofiaIO_gpio/S_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M09_AXI [get_bd_intf_pins ps8_0_axi_periph/M09_AXI] [get_bd_intf_pins SofiaIO_spi/AXI_LITE]
  ...
  connect_bd_net -net AD3552_SPI_A_DAC_HW_RESETn  [get_bd_pins AD3552_SPI_A/DAC_HW_RESETn] \
  [get_bd_ports FMC_HPC0_LA32_N]
  connect_bd_net -net AD3552_SPI_A_SPI_CSn  [get_bd_pins AD3552_SPI_A/SPI_CSn] \
  [get_bd_ports FMC_HPC0_LA10_P]
  connect_bd_net -net AD3552_SPI_A_SPI_SCLK  [get_bd_pins AD3552_SPI_A/SPI_SCLK] \
  [get_bd_ports FMC_HPC0_LA10_N]
  connect_bd_net -net AD3552_SPI_A_S_AXIS_TREADY  [get_bd_pins AD3552_SPI_A/S_AXIS_TREADY] \
  [get_bd_pins vio_0/probe_in0]
  connect_bd_net -net AD3552_SPI_A_XLATOR_DIR  [get_bd_pins AD3552_SPI_A/XLATOR_DIR] \
  [get_bd_ports FMC_HPC0_LA32_P]
  connect_bd_net -net AD3552_SPI_B_SPI_CSn  [get_bd_pins AD3552_SPI_B/SPI_CSn] \
  [get_bd_ports FMC_HPC0_LA27_P]
  connect_bd_net -net AD3552_SPI_B_SPI_SCLK  [get_bd_pins AD3552_SPI_B/SPI_SCLK] \
  [get_bd_ports FMC_HPC0_LA27_N]
  connect_bd_net -net AD3552_SPI_B_S_AXIS_TREADY  [get_bd_pins AD3552_SPI_B/S_AXIS_TREADY] \
  [get_bd_pins vio_0/probe_in1]
  connect_bd_net -net AD3552_SPI_B_XLATOR_DIR  [get_bd_pins AD3552_SPI_B/XLATOR_DIR] \
  [get_bd_ports FMC_HPC0_LA30_N]
  connect_bd_net -net DA_n_0_1  [get_bd_ports adc_DA_n] \
  [get_bd_pins QUAD_ADAQ23876_0/DA_n]
  connect_bd_net -net DA_p_0_1  [get_bd_ports adc_DA_p] \
  [get_bd_pins QUAD_ADAQ23876_0/DA_p]
  connect_bd_net -net DB_n_0_1  [get_bd_ports adc_DB_n] \
  [get_bd_pins QUAD_ADAQ23876_0/DB_n]
  connect_bd_net -net DB_p_0_1  [get_bd_ports adc_DB_p] \
  [get_bd_pins QUAD_ADAQ23876_0/DB_p]
  connect_bd_net -net FMC_HPC1_LA13_P_1  [get_bd_ports FMC_HPC0_LA13_P] \
  [get_bd_pins max7301_spi_0/io1_i]
  connect_bd_net -net LDAC_dout  [get_bd_pins LDAC_inv/Res] \
  [get_bd_ports PMOD1_2] \
  [get_bd_ports PMOD1_6] \
  [get_bd_ports FMC_HPC0_LA16_N] \
  [get_bd_ports FMC_HPC0_LA33_N]
  connect_bd_net -net Net  [get_bd_ports DAC_1_2_SPI_SDIO] \
  [get_bd_pins AD3552_SPI_A/SPI_SDIO]
  connect_bd_net -net Net1  [get_bd_ports DAC_3_4_SPI_SDIO] \
  [get_bd_pins AD3552_SPI_B/SPI_SDIO]
  connect_bd_net -net PMOD1_0_1  [get_bd_ports PMOD1_0] \
  [get_bd_pins xlconcat_1/In0]
  connect_bd_net -net PMOD1_1_1  [get_bd_ports PMOD1_1] \
  [get_bd_pins xlconcat_1/In1]
  connect_bd_net -net QUAD_ADAQ23876_0_SCLK_n  [get_bd_pins QUAD_ADAQ23876_0/SCLK_n] \
  [get_bd_ports adc_SCLK_n]
  connect_bd_net -net QUAD_ADAQ23876_0_SCLK_p  [get_bd_pins QUAD_ADAQ23876_0/SCLK_p] \
  [get_bd_ports adc_SCLK_p]
  connect_bd_net -net QUAD_ADAQ23876_0_cnv_n  [get_bd_pins QUAD_ADAQ23876_0/cnv_n] \
  [get_bd_ports adc_cnv_n]
  connect_bd_net -net QUAD_ADAQ23876_0_cnv_p  [get_bd_pins QUAD_ADAQ23876_0/cnv_p] \
  [get_bd_ports adc_cnv_p]
  connect_bd_net -net SofiaIO_gpio_gpio_io_o  [get_bd_pins SofiaIO_gpio/gpio_io_o] \
  ...
  connect_bd_net -net SofiaIO_spi_io0_o  [get_bd_pins SofiaIO_spi/io0_o] \
  [get_bd_ports PMOD1_5]
  connect_bd_net -net SofiaIO_spi_sck_o  [get_bd_pins SofiaIO_spi/sck_o] \
  [get_bd_ports PMOD1_3]
  connect_bd_net -net SofiaIO_spi_ss_o  [get_bd_pins SofiaIO_spi/ss_o] \
  [get_bd_pins util_vector_logic_1/Op1]
  connect_bd_net -net axi_gpio_0_ip2intc_irpt  [get_bd_pins axi_gpio_0/ip2intc_irpt] \
  [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_quad_spi_0_io0_o  [get_bd_pins max7301_spi_0/io0_o] \
  [get_bd_ports FMC_HPC0_LA13_N]
  connect_bd_net -net axi_quad_spi_0_sck_o  [get_bd_pins max7301_spi_0/sck_o] \
  [get_bd_ports FMC_HPC0_LA15_P]
  connect_bd_net -net axi_quad_spi_0_ss_o  [get_bd_pins max7301_spi_0/ss_o] \
  [get_bd_ports FMC_HPC0_LA15_N]
  connect_bd_net -net axi_timer_0_interrupt  [get_bd_pins axi_timer_0/interrupt] \
  [get_bd_pins QUAD_ADAQ23876_0/conv_strobe] \
  [get_bd_ports PMOD0_4] \
  [get_bd_pins util_vector_logic_0/Op1] \
  [get_bd_pins LDAC_inv/Op1]
  connect_bd_net -net axi_timer_1_interrupt  [get_bd_pins r5_sleep_timer_0/interrupt] \
  [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net io1_i_0_1  [get_bd_ports PMOD1_4] \
  [get_bd_pins SofiaIO_spi/io1_i]
  connect_bd_net -net pulldown_2_dout  [get_bd_pins pulldown_2/dout] \
  [get_bd_pins AD3552_SPI_A/S_AXIS_TSTRB] \
  [get_bd_pins AD3552_SPI_A/S_AXIS_TKEEP] \
  [get_bd_pins AD3552_SPI_B/S_AXIS_TSTRB] \
  [get_bd_pins AD3552_SPI_B/S_AXIS_TKEEP]
  connect_bd_net -net regbank_0_interrupt  [get_bd_pins regbank_0/interrupt] \
  [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net rst_ps8_0_124M_peripheral_aresetn  [get_bd_pins reset_125MHz/peripheral_aresetn] \
  [get_bd_pins regbank_0/s00_axi_aresetn] \
  [get_bd_pins QUAD_ADAQ23876_0/axi_aresetn] \
  [get_bd_pins AD3552_SPI_A/axi_aresetn] \
  [get_bd_pins AD3552_SPI_B/axi_aresetn] \
  [get_bd_pins axi_gpio_0/s_axi_aresetn] \
  [get_bd_pins SofiaIO_gpio/s_axi_aresetn] \
  [get_bd_pins max7301_spi_0/s_axi_aresetn] \
  [get_bd_pins SofiaIO_spi/s_axi_aresetn] \
  [get_bd_pins axi_timer_0/s_axi_aresetn] \
  [get_bd_pins r5_sleep_timer_0/s_axi_aresetn] \
  ...
  [get_bd_pins zynq_ultra_ps_e_0/nfiq0_lpd_rpu]
  ...
  [get_bd_pins SofiaIO_gpio/gpio2_io_i]
  connect_bd_net -net xlconstant_0_dout  [get_bd_pins xlconstant_0/dout] \
  [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net xlconstant_1_dout  [get_bd_pins xlconstant_1/dout] \
  [get_bd_pins AD3552_SPI_A/S_AXIS_TLAST] \
  [get_bd_pins AD3552_SPI_B/S_AXIS_TLAST]
  ...
  [get_bd_pins regbank_0/s00_axi_aclk] \
  [get_bd_pins QUAD_ADAQ23876_0/axi_aclk] \
  [get_bd_pins AD3552_SPI_A/axi_aclk] \
  [get_bd_pins AD3552_SPI_B/axi_aclk] \
  [get_bd_pins axi_gpio_0/s_axi_aclk] \
  [get_bd_pins SofiaIO_gpio/s_axi_aclk] \
  [get_bd_pins max7301_spi_0/ext_spi_clk] \
  [get_bd_pins max7301_spi_0/s_axi_aclk] \
  [get_bd_pins SofiaIO_spi/ext_spi_clk] \
  [get_bd_pins SofiaIO_spi/s_axi_aclk] \
  [get_bd_pins axi_timer_0/s_axi_aclk] \
  [get_bd_pins r5_sleep_timer_0/s_axi_aclk] \
  ...
  [get_bd_pins reset_125MHz/slowest_sync_clk] \
  ...
  [get_bd_pins reset_125MHz/ext_reset_in]

  # Create address segments
  assign_bd_address -offset 0x80040000 -range 0x00010000 -with_name SEG_AD3552_SPI_0_S00_AXI_reg -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs AD3552_SPI_A/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x80050000 -range 0x00010000 -with_name SEG_AD3552_SPI_0_S00_AXI_reg_1 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs AD3552_SPI_B/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x80070000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs QUAD_ADAQ23876_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x80080000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs SofiaIO_gpio/S_AXI/Reg] -force
  assign_bd_address -offset 0x80090000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs SofiaIO_spi/AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0x80030000 -range 0x00010000 -with_name SEG_axi_quad_spi_0_Reg -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs max7301_spi_0/AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0x80060000 -range 0x00010000 -with_name SEG_r5_sleep_timer_Reg -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs r5_sleep_timer_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x80020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs regbank_0/S00_AXI/S00_AXI_reg] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.809354",
   "Default View_TopLeft":"1521,2261",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.8.0 2024-04-26 e1825d835c VDI=44 GEI=38 GUI=JA:21.0 TLS
#  -string -flagsOSRD
preplace port dip_switches_8bits -pg 1 -lvl 7 -x 2620 -y 90 -defaultsOSRD
preplace port led_8bits -pg 1 -lvl 7 -x 2620 -y 110 -defaultsOSRD
preplace port port-id_FMC_HPC0_LA13_N -pg 1 -lvl 7 -x 2620 -y 810 -defaultsOSRD
preplace port port-id_FMC_HPC0_LA13_P -pg 1 -lvl 0 -x -70 -y 960 -defaultsOSRD
preplace port port-id_FMC_HPC0_LA15_P -pg 1 -lvl 7 -x 2620 -y 850 -defaultsOSRD
preplace port port-id_FMC_HPC0_LA10_P -pg 1 -lvl 7 -x 2620 -y 1040 -defaultsOSRD
preplace port port-id_FMC_HPC0_LA10_N -pg 1 -lvl 7 -x 2620 -y 1060 -defaultsOSRD
preplace port port-id_FMC_HPC0_LA32_P -pg 1 -lvl 7 -x 2620 -y 1080 -defaultsOSRD
preplace port port-id_FMC_HPC0_LA32_N -pg 1 -lvl 7 -x 2620 -y 1100 -defaultsOSRD
preplace port port-id_FMC_HPC0_LA27_P -pg 1 -lvl 7 -x 2620 -y 1320 -defaultsOSRD
preplace port port-id_FMC_HPC0_LA27_N -pg 1 -lvl 7 -x 2620 -y 1340 -defaultsOSRD
preplace port port-id_FMC_HPC0_LA30_N -pg 1 -lvl 7 -x 2620 -y 1360 -defaultsOSRD
preplace port port-id_PMOD1_3 -pg 1 -lvl 7 -x 2620 -y 2450 -defaultsOSRD
preplace port port-id_PMOD1_5 -pg 1 -lvl 7 -x 2620 -y 2410 -defaultsOSRD
preplace port port-id_PMOD1_4 -pg 1 -lvl 0 -x -70 -y 2780 -defaultsOSRD
preplace port port-id_PMOD1_1 -pg 1 -lvl 0 -x -70 -y 2250 -defaultsOSRD
preplace port port-id_PMOD1_0 -pg 1 -lvl 0 -x -70 -y 2230 -defaultsOSRD
preplace portBus DAC_1_2_SPI_SDIO -pg 1 -lvl 7 -x 2620 -y 1120 -defaultsOSRD
preplace portBus DAC_3_4_SPI_SDIO -pg 1 -lvl 7 -x 2620 -y 1400 -defaultsOSRD
preplace portBus adc_cnv_p -pg 1 -lvl 7 -x 2620 -y 1730 -defaultsOSRD
preplace portBus adc_cnv_n -pg 1 -lvl 7 -x 2620 -y 1750 -defaultsOSRD
preplace portBus adc_SCLK_p -pg 1 -lvl 7 -x 2620 -y 1770 -defaultsOSRD
preplace portBus adc_SCLK_n -pg 1 -lvl 7 -x 2620 -y 1790 -defaultsOSRD
preplace portBus adc_DA_p -pg 1 -lvl 0 -x -70 -y 1770 -defaultsOSRD
preplace portBus adc_DA_n -pg 1 -lvl 0 -x -70 -y 1790 -defaultsOSRD
preplace portBus adc_DB_p -pg 1 -lvl 0 -x -70 -y 1810 -defaultsOSRD
preplace portBus adc_DB_n -pg 1 -lvl 0 -x -70 -y 1830 -defaultsOSRD
preplace portBus PMOD1_7 -pg 1 -lvl 7 -x 2620 -y 2660 -defaultsOSRD
preplace portBus PMOD0_0 -pg 1 -lvl 7 -x 2620 -y 1850 -defaultsOSRD
preplace portBus PMOD0_1 -pg 1 -lvl 7 -x 2620 -y 1950 -defaultsOSRD
preplace portBus PMOD0_2 -pg 1 -lvl 7 -x 2620 -y 2050 -defaultsOSRD
preplace portBus PMOD0_3 -pg 1 -lvl 7 -x 2620 -y 2150 -defaultsOSRD
preplace portBus PMOD0_7 -pg 1 -lvl 7 -x 2620 -y 2250 -defaultsOSRD
preplace portBus PMOD1_2 -pg 1 -lvl 7 -x 2620 -y 1550 -defaultsOSRD
preplace portBus PMOD1_6 -pg 1 -lvl 7 -x 2620 -y 1570 -defaultsOSRD
preplace portBus FMC_HPC0_LA16_N -pg 1 -lvl 7 -x 2620 -y 1510 -defaultsOSRD
preplace portBus FMC_HPC0_LA33_N -pg 1 -lvl 7 -x 2620 -y 1530 -defaultsOSRD
preplace portBus FMC_HPC0_LA15_N -pg 1 -lvl 7 -x 2620 -y 870 -defaultsOSRD
preplace portBus PMOD0_4 -pg 1 -lvl 7 -x 2620 -y 1490 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 3 -x 910 -y 440 -defaultsOSRD
preplace inst axi_timer_0 -pg 1 -lvl 5 -x 2030 -y 620 -defaultsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 4 -x 1570 -y 660 -defaultsOSRD
preplace inst reset_125MHz -pg 1 -lvl 3 -x 910 -y 630 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 5 -x 2030 -y 110 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 2 -x 430 -y 490 -defaultsOSRD
preplace inst regbank_0 -pg 1 -lvl 5 -x 2030 -y 250 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 1 -x 100 -y 460 -defaultsOSRD
preplace inst util_vector_logic_0 -pg 1 -lvl 2 -x 430 -y 360 -defaultsOSRD
preplace inst max7301_spi_0 -pg 1 -lvl 5 -x 2030 -y 840 -defaultsOSRD
preplace inst AD3552_SPI_A -pg 1 -lvl 5 -x 2030 -y 1080 -defaultsOSRD
preplace inst AD3552_SPI_B -pg 1 -lvl 5 -x 2030 -y 1360 -defaultsOSRD
preplace inst r5_sleep_timer_0 -pg 1 -lvl 5 -x 2030 -y 420 -defaultsOSRD
preplace inst QUAD_ADAQ23876_0 -pg 1 -lvl 5 -x 2030 -y 1760 -defaultsOSRD
preplace inst LDAC_inv -pg 1 -lvl 5 -x 2030 -y 1570 -defaultsOSRD
preplace inst system_ila_0 -pg 1 -lvl 5 -x 2030 -y 1950 -defaultsOSRD
preplace inst pulldown_2 -pg 1 -lvl 4 -x 1570 -y 1330 -defaultsOSRD
preplace inst vio_0 -pg 1 -lvl 4 -x 1570 -y 1080 -defaultsOSRD
preplace inst xlconstant_1 -pg 1 -lvl 4 -x 1570 -y 1230 -defaultsOSRD
preplace inst SofiaIO_gpio -pg 1 -lvl 5 -x 2030 -y 2100 -defaultsOSRD
preplace inst SofiaIO_spi -pg 1 -lvl 5 -x 2030 -y 2520 -defaultsOSRD
preplace inst xlconcat_1 -pg 1 -lvl 5 -x 2030 -y 2300 -defaultsOSRD
preplace inst xlslice_0 -pg 1 -lvl 6 -x 2440 -y 1840 -defaultsOSRD
preplace inst xlslice_1 -pg 1 -lvl 6 -x 2440 -y 1940 -defaultsOSRD
preplace inst xlslice_2 -pg 1 -lvl 6 -x 2440 -y 2040 -defaultsOSRD
preplace inst xlslice_3 -pg 1 -lvl 6 -x 2440 -y 2140 -defaultsOSRD
preplace inst xlslice_4 -pg 1 -lvl 6 -x 2440 -y 2240 -defaultsOSRD
preplace inst util_vector_logic_1 -pg 1 -lvl 5 -x 2030 -y 2670 -defaultsOSRD
preplace inst xlslice_5 -pg 1 -lvl 6 -x 2440 -y 2340 -defaultsOSRD
preplace inst util_vector_logic_2 -pg 1 -lvl 6 -x 2440 -y 2660 -defaultsOSRD
preplace inst xlconstant_2 -pg 1 -lvl 4 -x 1570 -y 2370 -defaultsOSRD
preplace netloc AD3552_SPI_A_DAC_HW_RESETn 1 5 2 N 1100 N
preplace netloc AD3552_SPI_A_SPI_CSn 1 5 2 N 1040 N
preplace netloc AD3552_SPI_A_SPI_SCLK 1 5 2 N 1060 N
preplace netloc AD3552_SPI_A_S_AXIS_TREADY 1 3 2 1420 1170 1720
preplace netloc AD3552_SPI_A_XLATOR_DIR 1 5 2 N 1080 N
preplace netloc AD3552_SPI_B_SPI_CSn 1 5 2 N 1320 N
preplace netloc AD3552_SPI_B_SPI_SCLK 1 5 2 N 1340 N
preplace netloc AD3552_SPI_B_S_AXIS_TREADY 1 3 2 1430 1410 N
preplace netloc AD3552_SPI_B_XLATOR_DIR 1 5 2 N 1360 N
preplace netloc DA_n_0_1 1 0 5 NJ 1790 NJ 1790 NJ 1790 NJ 1790 NJ
preplace netloc DA_p_0_1 1 0 5 NJ 1770 NJ 1770 NJ 1770 NJ 1770 NJ
preplace netloc DB_n_0_1 1 0 5 NJ 1830 NJ 1830 NJ 1830 NJ 1830 NJ
preplace netloc DB_p_0_1 1 0 5 NJ 1810 NJ 1810 NJ 1810 NJ 1810 NJ
preplace netloc FMC_HPC1_LA13_P_1 1 0 6 N 960 NJ 960 NJ 960 NJ 960 1780J 730 2190
preplace netloc LDAC_dout 1 5 2 N 1570 2600
preplace netloc Net 1 5 2 N 1120 N
preplace netloc Net1 1 5 2 N 1400 N
preplace netloc PMOD1_0_1 1 0 5 NJ 2230 NJ 2230 NJ 2230 NJ 2230 N
preplace netloc PMOD1_1_1 1 0 5 NJ 2250 NJ 2250 NJ 2250 NJ 2250 N
preplace netloc QUAD_ADAQ23876_0_SCLK_n 1 5 2 2210 1780 2590
preplace netloc QUAD_ADAQ23876_0_SCLK_p 1 5 2 N 1770 N
preplace netloc QUAD_ADAQ23876_0_cnv_n 1 5 2 N 1750 N
preplace netloc QUAD_ADAQ23876_0_cnv_p 1 5 2 N 1730 N
preplace netloc SofiaIO_gpio_gpio_io_o 1 5 1 2290 1840n
preplace netloc SofiaIO_spi_io0_o 1 5 2 2190 2410 N
preplace netloc SofiaIO_spi_sck_o 1 5 2 2200 2450 N
preplace netloc SofiaIO_spi_ss_o 1 4 2 1880 2730 2180
preplace netloc axi_gpio_0_ip2intc_irpt 1 1 5 250 10 NJ 10 NJ 10 NJ 10 2210
preplace netloc axi_quad_spi_0_io0_o 1 5 2 N 810 N
preplace netloc axi_quad_spi_0_sck_o 1 5 2 NJ 850 N
preplace netloc axi_quad_spi_0_ss_o 1 5 2 N 870 N
preplace netloc axi_timer_0_interrupt 1 1 6 260 1510 NJ 1510 NJ 1510 1870J 1510 2210 1490 N
preplace netloc axi_timer_1_interrupt 1 1 5 270 20 NJ 20 NJ 20 NJ 20 2200
preplace netloc io1_i_0_1 1 0 6 NJ 2780 NJ 2780 NJ 2780 NJ 2780 NJ 2780 2190
preplace netloc pulldown_2_dout 1 4 1 1880 1090n
preplace netloc regbank_0_interrupt 1 1 5 280 30 NJ 30 NJ 30 NJ 30 2190
preplace netloc rst_ps8_0_124M_peripheral_aresetn 1 3 2 1420J 360 1850
preplace netloc util_vector_logic_0_Res 1 2 1 580 360n
preplace netloc util_vector_logic_1_Res 1 5 1 N 2670
preplace netloc util_vector_logic_2_Res 1 6 1 N 2660
preplace netloc vio_0_probe_out0 1 4 1 N 1050
preplace netloc vio_0_probe_out1 1 4 1 1860 1030n
preplace netloc vio_0_probe_out2 1 4 1 1760 1090n
preplace netloc vio_0_probe_out3 1 4 1 1750 1110n
preplace netloc xlconcat_0_dout 1 2 1 N 490
preplace netloc xlconcat_1_dout 1 5 1 2190 2130n
preplace netloc xlconstant_0_dout 1 1 1 N 460
preplace netloc xlconstant_1_dout 1 4 1 1870 1070n
preplace netloc xlconstant_2_dout 1 4 1 1880 2270n
preplace netloc xlslice_0_Dout 1 6 1 2590 1840n
preplace netloc xlslice_1_Dout 1 6 1 2590 1940n
preplace netloc xlslice_2_Dout 1 6 1 2590 2040n
preplace netloc xlslice_3_Dout 1 6 1 2590 2140n
preplace netloc xlslice_4_Dout 1 6 1 2590 2240n
preplace netloc xlslice_5_Dout 1 5 2 2290 2420 2590
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 2 3 610 320 1410 320 1840
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 2 2 620 330 1200
preplace netloc QUAD_ADAQ23876_0_M_AXIS 1 4 2 1880 1630 2190
preplace netloc axi_gpio_0_GPIO 1 5 2 NJ 90 N
preplace netloc axi_gpio_0_GPIO2 1 5 2 N 110 N
preplace netloc ps8_0_axi_periph_M00_AXI 1 4 1 NJ 570
preplace netloc ps8_0_axi_periph_M01_AXI 1 4 1 1710 90n
preplace netloc ps8_0_axi_periph_M02_AXI 1 4 1 1720 230n
preplace netloc ps8_0_axi_periph_M03_AXI 1 4 1 1860 630n
preplace netloc ps8_0_axi_periph_M04_AXI 1 4 1 1720 650n
preplace netloc ps8_0_axi_periph_M05_AXI 1 4 1 1710 670n
preplace netloc ps8_0_axi_periph_M06_AXI 1 4 1 1730 370n
preplace netloc ps8_0_axi_periph_M07_AXI 1 4 1 1770 710n
preplace netloc ps8_0_axi_periph_M08_AXI 1 4 1 1740 730n
preplace netloc ps8_0_axi_periph_M09_AXI 1 4 1 1730 750n
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_LPD 1 3 1 NJ 420
levelinfo -pg 1 -70 100 430 910 1570 2030 2440 2620
pagesize -pg 1 -db -bbox -sgen -260 -20 2850 2800
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse [list design_1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/r5ctrlr.gen/sources_1/bd/design_1/hdl/design_1_wrapper.vhd" ]
} else {
